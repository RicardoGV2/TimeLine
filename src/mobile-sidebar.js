function ensureMobileSidebarControls() {
  ...
  actions.innerHTML = `
    <button type="button" class="mobile-expand-sidebar">Expand</button>
    <button type="button" class="mobile-close-sidebar">Close</button>
  `;
  ...
  actions.querySelector('.mobile-close-sidebar')?.addEventListener('click', closeMobileSidebar);
